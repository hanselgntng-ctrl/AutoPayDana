...
def main():
    ...
    if app.job_queue is not None:
        ...
        logger.warning(
            ...
            "Berulang, dan Auto-Post Testimoni semuanya nonaktif. Install dengan: "
