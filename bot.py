...
def install_chat_cleaner(bot):
    """Pasang wrapper tipis di atas bot.send_message & bot.send_photo supaya
    SETIAP pemanggilan lewat keduanya (termasuk lewat `update.message.reply_text()`
    ...
    async def send_message(*args, **kwargs):
        ...
        await _cleanup_previous_messages(bot, chat_id)
