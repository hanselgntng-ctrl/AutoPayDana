...
def settings_menu_kb() -> InlineKeyboardMarkup:
    ...
    tutup_row = rows.pop() if rows else [InlineKeyboardButton("❎ Tutup", callback_data="settings_close")]

    rows.append([
        InlineKeyboardButton("📊✨ Statistik Bot", callback_data="settings_stats"),
        InlineKeyboardButton("📢💎 Broadcast Pesan", callback_data="settings_broadcast"),
    ])
...
async def start_purchase_flow(chat_id: int, telegram_user, context: ContextTypes.DEFAULT_TYPE,
    ...
    # nominal final dihitung BERBASIS `tx_id` ini (lihat dana_api.py &
    ...
    final_amount, unique_code = dana_api.generate_unique_code(pkg["price"], tx_id)
    ...
    # otomatis di dana_api.find_matching_mutation() -- cuma cara usernya bayar
    # yang berubah jadi lebih gampang.
